            ...
            >
                ...
                <DialogBody>
                    ...
                    <div className="flex justify-center flex-wrap sm:mx-auto sm:mb-2 -mx-2 mt-4 mb-2">
                        {
                            getAllBlog
                                .filter((obj) => obj.blogs.title.toLowerCase().includes(searchkey.toLowerCase())) // Fixed case sensitivity
                                .map((item, index) => {
                                    return (
                                        <div key={index} className="p-2 sm:w-1/4 w-full">
                                            <div
                                                onClick={() => navigate(`/bloginfo/${item.id}`)} // Corrected the navigation handler
                    ...
                    <div className="text-center">
                        <h1 className="text-gray-600">Powered By Shayan</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
